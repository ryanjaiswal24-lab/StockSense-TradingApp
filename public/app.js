...
function initMobileUI() {
  ...
  const btnDesktopSwitchMobile = document.getElementById("btn-desktop-switch-mobile");
  const btnMobileSwitchDesktop = document.getElementById("mobile-switch-desktop");
  
  btnDesktopSwitchMobile?.addEventListener("click", (e) => {
    e.preventDefault();
    window.setViewMode("mobile");
  });
  
  btnMobileSwitchDesktop?.addEventListener("click", (e) => {
    e.preventDefault();
